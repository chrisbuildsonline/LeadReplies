          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <h2
                ...
                data-testid="platform-performance-title"
              >
                Platform Performance
              </h2>
              {isLoading ? (
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <h2
                ...
                data-testid="today-performance-title"
              >
                Today's Performance
              </h2>
              {isLoading ? (
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      ...
                      data-testid="replies-sent-today"
                    >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className="font-semibold text-gray-900"
                      data-testid="clicks-generated-today"
                    >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      ...
                      data-testid="engagement-rate-today"
                    >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className="font-semibold text-gray-900"
                      data-testid="keywords-tracked-today"
                    >
